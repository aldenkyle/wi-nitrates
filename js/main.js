...
function onEachFeature(feature,layer) {
    ...
    var nov22Food = feature.properties.Nov_2022.toFixed(1)*100;
    ...
    var popupContent = '<b>' + regionName + ', ' + countryName + '</b><br>' +
        'Insufficient Food Consumption (Nov 2022): ' + nov22Food + '%<br>Female Avg. Years of Educational Attainment: '
        + femaleEdu + '<br>Male Avg Years of Educational Attainment:' + maleEdu + '<br>'
       ;
